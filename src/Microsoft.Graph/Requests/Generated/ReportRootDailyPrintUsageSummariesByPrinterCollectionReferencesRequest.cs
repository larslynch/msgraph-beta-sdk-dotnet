...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ReportRootDailyPrintUsageSummariesByPrinterCollectionReferencesRequest : BaseRequest, IReportRootDailyPrintUsageSummariesByPrinterCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ReportRootDailyPrintUsageSummariesByPrinterCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ReportRootDailyPrintUsageSummariesByPrinterCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
