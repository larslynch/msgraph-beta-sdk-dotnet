...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PrintUsageSummaryByPrinterWithReferenceRequest.
    /// </summary>
    public partial class PrintUsageSummaryByPrinterWithReferenceRequest : BaseRequest, IPrintUsageSummaryByPrinterWithReferenceRequest
    {
        /// <summary>
        /// Constructs a new PrintUsageSummaryByPrinterWithReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PrintUsageSummaryByPrinterWithReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<PrintUsageSummaryByPrinter> GetAsync()
        {
        ...
        /// <returns>The PrintUsageSummaryByPrinter.</returns>
        public async System.Threading.Tasks.Task<PrintUsageSummaryByPrinter> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<PrintUsageSummaryByPrinter>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<PrintUsageSummaryByPrinter> UpdateAsync(PrintUsageSummaryByPrinter printUsageSummaryByPrinterToUpdate)
        {
            return this.UpdateAsync(printUsageSummaryByPrinterToUpdate, CancellationToken.None);
        }
        ...
        {
            this.Method = "DELETE";
            await this.SendAsync<PrintUsageSummaryByPrinter>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public IPrintUsageSummaryByPrinterWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPrintUsageSummaryByPrinterWithReferenceRequest Expand(Expression<Func<PrintUsageSummaryByPrinter, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPrintUsageSummaryByPrinterWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPrintUsageSummaryByPrinterWithReferenceRequest Select(Expression<Func<PrintUsageSummaryByPrinter, object>> selectExpression)
        {
