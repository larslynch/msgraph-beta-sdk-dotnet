    ...
    public partial class IdentityContainerRequest : BaseRequest, IIdentityContainerRequest
    {
        ...
        private void InitializeCollectionProperties(IdentityContainer identityContainerToInitialize)
        {
            ...
            if (identityContainerToInitialize != null && identityContainerToInitialize.AdditionalData != null)
            {
                ...
                if (identityContainerToInitialize.FeatureConfigurations != null && identityContainerToInitialize.FeatureConfigurations.CurrentPage != null)
                {
                    identityContainerToInitialize.FeatureConfigurations.AdditionalData = identityContainerToInitialize.AdditionalData;

                    object nextPageLink;
                    identityContainerToInitialize.AdditionalData.TryGetValue("featureConfigurations@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        identityContainerToInitialize.FeatureConfigurations.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
